...
if ( @$contact == 1 ) {
	...
	add_action( 'init', 'customize_contact_post_type' );

	add_filter( 'manage_'.'contact_form_type'.'_posts_columns', 'set_contact_form_columns', 10, 1 );
	add_action( 'manage_'.'contact_form_type'.'_posts_custom_column', 'contact_custom_column', 10, 2 );
